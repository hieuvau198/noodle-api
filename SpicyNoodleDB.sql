...
PRINT 'Tables created: Users, SpiceLevels, Toppings, SpicyNoodles, Orders, OrderItems, NoodleToppings, NoodleSpiceLevels, Payments';
PRINT 'All tables have been seeded with sample data.';